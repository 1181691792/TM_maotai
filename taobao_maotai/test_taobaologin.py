...
class UsernameLogin:
    ...
    def check_demo(self):
        ...
        # st = self._apply_st()
        data = {
            'item': '2328048666056_20739895092_1_4227830352490_3001638840_0_0_0_buyerCondition~0~~dpbUpgrade~null~~cartCreateTime~1609381368521__0',
            'buyer_from': 'cart',
            'source_time': S
        }
    ...
    def check_demo1(self):
        ...
        st = self._apply_st()
        data = {
            'item': '2328048666056_629225427775_1_4227830352490_3001638840_0_0_0_buyerCondition~0~~dpbUpgrade~null~~cartCreateTime~1609381368521__0',
            'buyer_from': 'cart',
            'source_time': S
        }
...
if __name__ == '__main__':
    ul = UsernameLogin(global_config.getRaw('config', 'loginId'), global_config.getRaw('config', 'umidToken'),global_config.getRaw('config', 'ua'), global_config.getRaw('config', 'password2'))
    ul.login()
